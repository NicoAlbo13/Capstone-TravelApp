const refreshUI = async (city) => {
    ...
    try{
        ...
        document.getElementById('general').innerHTML = `The city of ${city} you are visiting is located in ${allData[1].region}.
                                                        ${city} is located in the ${allData[1].name} and its capital is ${allData[1].capital}.
